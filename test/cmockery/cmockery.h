...
// Assert that the two given integers are equal, otherwise fail.
#define assert_timeval_equal(a, b) _assert_timeval_equal(a, b, __FILE__, __LINE__)

// Assert that the two given integers are equal, otherwise fail.
#define assert_float_equal(a, b, e) _assert_float_equal(a, b, e, __FILE__, __LINE__)
...
// Assert that the two given strings are equal, otherwise fail.
#define assert_stringn_equal(a, b, len) \
    _assert_stringn_equal((const char*)a, (const char*)b, len, __FILE__, __LINE__)
// Assert that the two given strings are not equal, otherwise fail.
#define assert_stringn_not_equal(a, b, len) \
    _assert_stringn_not_equal((const char*)a, (const char*)b, len, __FILE__, \
                             __LINE__)
